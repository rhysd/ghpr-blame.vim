...
execute join(['function! vital#_ghpr_blame#Async#Promise#import() abort', printf("return map({'resolve': '', 'all': '', 'race': '', 'noop': '', 'is_promise': '', 'is_available': '', 'reject': '', 'new': ''}, \"vital#_ghpr_blame#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
